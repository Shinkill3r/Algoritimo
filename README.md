...
public class Main{
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.print(" ");
            tema = leia.next().charAt(0);  // -----> //A variavel tema ira receber a entrada de leitura .

            /*Aqui ocorre a validação da variável "TEMA", para caso seja informado uma opção inválida será exibida uma mensagem,
             e ira repetir o menu até que o usuario escolha uma opção do menu ou arranque o pc da tomada.*/
            ...
            switch (tema) {                  
                ...
                if(sair == false){          /*Este if faz a comparação da variável "sair", ser for verdadeiro continua executando o programa
                                            a baixo, se não ele irá saltar para o proximo if que também irá comparar, assim passando por todos 
                                            os if voltando para o menu inicial, colocado apenas para ter uma opção de sair a cada pergunta*/

                        do{
                               //Primeira pergunta no laço de repetição DO.
                            ...
                            System.out.println("e) Voltar ao Menu");
                                ...
                                //p1 é a variável que recebe o leia armazenando a informação do usuário.
                            
                            p1 = leia.next().charAt(0);                 

                                /*Este if compara a variável p1 com a resposta, se for igual a resposta, será exibida a mensagem e a variável acerto receberá +1,
                            caso o contrário, o else if confirma se o usuario digitou uma opção válida, caso a opção escolhida for "e" a variável sair passará a ser true,
                            saltando todas as perguntas e voltando para o menu inicial, se a opção escolhida for diferente do if e não atender nenhuma das condições dos
                            else if então o else será executado exibindo a mensagem e a variável erro receberá +1*/
                        ...
                        do{
                                //Segunda pergunta no laço de repetição DO.
                            ...
                            //p2 é a variável que recebe o leia armazenando a informação do usuário.
                            
                            p2 = leia.next().charAt(0); 
                            
                                /*Este if compara a variável p2 com a resposta, se for igual a resposta, será exibida a mensagem e a variável acerto receberá +1,
                            caso o contrário, o else if confirma se o usuario digitou uma opção válida, caso a opção escolhida for "e" a variável sair passará a ser true,
                            saltando todas as perguntas e voltando para o menu inicial, se a opção escolhida for diferente do if e não atender nenhuma das condições dos
                            else if então o else será executado exibindo a mensagem e a variável erro receberá +1*/
                        ...
                        do{
                            //Terceira pergunta no laço de repetição DO.
                            ...
                            p3 = leia.next().charAt(0);                 //Aqui a resposta vai ser guardada na variável "p3".
                                ...
                                /*Este if compara a variável p3 com a resposta, se for igual a resposta, será exibida a mensagem e a variável acerto receberá +1,
                            caso o contrário, o else if confirma se o usuario digitou uma opção válida, caso a opção escolhida for "e" a variável sair passará a ser true,
                            saltando todas as perguntas e voltando para o menu inicial, se a opção escolhida for diferente do if e não atender nenhuma das condições dos
                            else if então o else será executado exibindo a mensagem e a variável erro receberá +1*/
                        ...
                        do{ 
                            ...
                            //Quarta pergunta no laço de repetição DO.
                            ...
                            p4 = leia.next().charAt(0);                 //Aqui a resposta vai ser guardada na variável "p4".
                                ...
                                /*Este if compara a variável p4 com a resposta, se for igual a resposta, será exibida a mensagem e a variável acerto receberá +1,
                            caso o contrário, o else if confirma se o usuario digitou uma opção válida, caso a opção escolhida for "e" a variável sair passará a ser true,
                            saltando todas as perguntas e voltando para o menu inicial, se a opção escolhida for diferente do if e não atender nenhuma das condições dos
                            else if então o else será executado exibindo a mensagem e a variável erro receberá +1*/
                        ...
                        do{
                                //Quinta pergunta no laço de repetição DO.
                            ...
                            p5 = leia.next().charAt(0);                 //Aqui a resposta vai ser guardada na variável "p5".
                                ...
                                /*Este if compara a variável p5 com a resposta, se for igual a resposta, será exibida a mensagem e a variável acerto receberá +1,
                            caso o contrário, o else if confirma se o usuario digitou uma opção válida, caso a opção escolhida for "e" a variável sair passará a ser true,
                            saltando todas as perguntas e voltando para o menu inicial, se a opção escolhida for diferente do if e não atender nenhuma das condições dos
                            else if então o else será executado exibindo a mensagem e a variável erro receberá +1*/
                            ...
                            /*Se a condição if for falsa e o usuário passar por todos as alternativas do (DO While) chegando ao final, 
                            o primeiro questionário chegará ao fim e será apresentado o resultado das variáveis "acerto" e " errou", 
                            mostrando ao usuário o taltal de erros e acertos que ele teve dando um break e voltando ao menu inicial*/
